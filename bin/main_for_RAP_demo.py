...
from RAP_demo.raster_init_for_RAP_demo import init_raster_candidate
...
def main():
    ...
    # Phase I
    raster_candidate = init_raster_candidate('../log/topo_for_RAP_demo',
                                             '../log/stream_for_RAP_demo',
                                             bandwidth=1000,
                                             max_d=1.2,
    ...
    for raster in raster_candidate:
